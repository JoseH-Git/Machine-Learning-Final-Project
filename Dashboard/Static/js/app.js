...
function barChart(group_by,country,artist,track,datefrom,dateto,xAxisTitle,id,bar_color){
    d3.json('http://127.0.0.1:5000/users?Group_by='+ group_by + '&Country=' + country + '&Artist=' + artist + '&Track_Name=' + track + '&datefrom='+ datefrom + '&dateto=' + dateto).then(importedData=>{
...
function donutChart(group_by,country,artist,track,datefrom,dateto,id){
    d3.json('http://127.0.0.1:5000/users?Group_by='+ group_by + '&Gender=').then(importedData=>{
